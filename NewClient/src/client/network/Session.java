...
//    }
    ...
    public void handleResponse(Message incoming){
        if(incoming.getData("response").equals("accept")){
            ...
            Platform.runLater(() -> {
                ...
                ClientApp.gameController.img = new Image(Session.this.getClass().getResourceAsStream("/resources/images/xx.png"));
            });
        }else{
    ...
    public void playWithAI(){
        ...
        IAmX = true;
        myTurn = true;
        ClientApp.gameController.img = new Image(getClass().getResourceAsStream("/resources/images/xx.png"));
    }
    ...
    private void handleMove(Message message) {
        myTurn = true;
        Platform.runLater(() -> {
            btns[Integer.parseInt(message.getData("x"))][Integer.parseInt(message.getData("y"))].setGraphic(new ImageView(IAmX?"/resources/images/oo.png":"/resources/images/xx.png"));
